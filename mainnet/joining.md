...
is [v0.27.1](https://github.com/sovrn-tech/sovr-networks/releases/tag/v0.27.1):

| Artifact | Notes |
|---|---|
| `sovrd-v0.27.1-linux-amd64` | The chain daemon. linux/amd64, glibc ≥ 2.36 |
...
```
ghcr.io/sovrn-tech/sovrd:v0.27.1
digest: sha256:479ff7ce30a85dc0562bdb3837d3d6418873846aca12697887df714229e39bcd
```
...
against the live network and the v0.27.1 release manifest, 2026-09-16.*
